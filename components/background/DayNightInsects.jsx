// components/background/DayNightInsects.jsx
...
export default function DayNightInsects() {
  ...
  // Don’t render any bugs until we’ve run on the client
  if (fireflies.length === 0 && bees.length === 0) {
    return null;
  }
    ...
    <div className="absolute inset-0 z-[1] pointer-events-none">
        ...
        {fireflies.map((bug) => (
          <div
            ...
            style={{
              ...
              filter: `blur(0.5px) drop-shadow(0 0 ${
                bug.size * 2
              }px ${bug.color})`,
      ...
      <style>{`
        @keyframes firefly-glow {
          ...
          25% { transform: translateY(-5px) translateX(5px) scale(1.1); opacity: 0.8; }
          50% { transform: translateY(10px) translateX(-10px) scale(1); opacity: 0.5; }
          75% { transform: translateY(-8px) translateX(8px) scale(1.1); opacity: 1; }
        }
        ...
        @keyframes bee-flight {
          ...
          80% { transform: translate(-8px, 0) rotate(-10deg); }
