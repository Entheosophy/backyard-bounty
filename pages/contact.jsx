...
export default function Contact() {
  ...
  return (
    <section className="max-w-md mx-auto px-6 py-12">
      <div className="bg-white/10 backdrop-blur-md rounded-lg shadow-lg px-8 pt-2 pb-8">
        <h2 className="text-2xl font-semibold mb-4 mt-0">Contact Us</h2>
        <p className="opacity-80 mb-6">
          Want to place an order or say hi to Tim? Fill out the form below or email us directly.
        </p>
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          {status === "sent" && (
            <p className="text-green-600 pt-2">Thanks! Tim will be in touch.</p>
          )}
          {status === "error" && (
