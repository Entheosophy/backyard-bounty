  ...
  return (
    <div className="pt-36 space-y-16">
      ...
      <section id="home" className="max-w-4xl mx-auto px-6 text-center">
        <div className="backdrop-blur-md rounded-lg shadow-lg px-8 pt-6 pb-8">
      ...
      <section id="where-to-buy" className="max-w-3xl mx-auto px-6">
        <div className="backdrop-blur-md rounded-lg shadow-lg px-8 pt-2 pb-8">
      ...
      <section id="contact" className="max-w-md mx-auto px-6">
        <div className="backdrop-blur-md rounded-lg shadow-lg px-8 pt-2 pb-8 text-center">
          ...
          <a
            ...
            className="inline-block bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded font-semibold"
          >
            Email Tim
          </a>
        </div>
